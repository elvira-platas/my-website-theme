...
* Unified the responsive menu button and dropdown styling across desktop and mobile layouts.
* Added a translatable accessible label to the responsive menu control.
...
* Aligned the block editor's body typography with published posts.
