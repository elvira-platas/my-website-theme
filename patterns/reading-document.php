...
<p class="is-style-kilka-reading-byline"><?php esc_html_e( 'Author name', 'kilka' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"className":"is-style-kilka-reading-text"} -->
<div class="wp-block-group is-style-kilka-reading-text"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Add the text here. Use paragraphs, headings, images, and separators in their reading order.', 'kilka' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->

<!-- wp:group {"className":"is-style-kilka-reading-note"} -->
<div class="wp-block-group is-style-kilka-reading-note"><!-- wp:paragraph -->
<p><?php esc_html_e( 'Optional source or rights note. Remove this group if it is not needed.', 'kilka' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
